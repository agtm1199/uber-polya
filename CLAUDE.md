...
- **v0.9.0**: Four skills (orchestrator + trilogy) with 277 algorithms (174 discrete/continuous/linear-algebra/calculus/geometry/financial/game-theory/decision-analysis/multi-objective/ODEs + 103 statistical/time-series/stochastic/survival/ML/simulation/queuing), 83 structures across 21 domains, 25 solver libraries. Fifteen shipped domains: discrete math, continuous optimization, statistical inference, time series analysis, stochastic processes, survival analysis, linear algebra, calculus, geometry & trigonometry, financial mathematics, game theory, decision analysis, multi-objective optimization, machine learning, simulation & ODEs. Model templates for top 5 patterns. Solving protocols and optimization hardening extracted to reference files. Cross-reference indexes in all reference files. Thirty-two worked examples.

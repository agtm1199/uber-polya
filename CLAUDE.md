...
- **v0.7.0**: Four skills (orchestrator + trilogy) with 232 algorithms (164 discrete/continuous/linear-algebra/calculus/geometry/financial/game-theory/decision-analysis/multi-objective + 68 statistical/time-series/stochastic/survival), 70 structures across 19 domains, 22 solver libraries. Thirteen shipped domains: discrete math, continuous optimization, statistical inference, time series analysis, stochastic processes, survival analysis, linear algebra, calculus, geometry & trigonometry, financial mathematics, game theory, decision analysis, multi-objective optimization. Model templates for top 5 patterns. Solving protocols and optimization hardening extracted to reference files. Cross-reference indexes in all reference files. Twenty-six worked examples.

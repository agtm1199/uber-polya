...
- **v0.8.0**: Four skills (orchestrator + trilogy) with 254 algorithms (164 discrete/continuous/linear-algebra/calculus/geometry/financial/game-theory/decision-analysis/multi-objective + 90 statistical/time-series/stochastic/survival/ML), 75 structures across 20 domains, 24 solver libraries. Fourteen shipped domains: discrete math, continuous optimization, statistical inference, time series analysis, stochastic processes, survival analysis, linear algebra, calculus, geometry & trigonometry, financial mathematics, game theory, decision analysis, multi-objective optimization, machine learning. Model templates for top 5 patterns. Solving protocols and optimization hardening extracted to reference files. Cross-reference indexes in all reference files. Twenty-nine worked examples.

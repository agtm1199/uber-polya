...
- **v0.6.0**: Four skills (orchestrator + trilogy) with 209 algorithms (164 discrete/continuous/linear-algebra/calculus/geometry/financial/game-theory/decision-analysis/multi-objective + 45 statistical), 64 structures across 17 domains, 19 solver libraries. Ten shipped domains: discrete math, continuous optimization, statistical inference, linear algebra, calculus, geometry & trigonometry, financial mathematics, game theory, decision analysis, multi-objective optimization. Model templates for top 5 patterns. Solving protocols and optimization hardening extracted to reference files. Cross-reference indexes in all reference files. Twenty-three worked examples.
